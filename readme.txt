...
= 2.2.0 =
* Add edit function to stored images
* Fix bug in saving is_tag (was always setting to 1
= 2.1.0 =
* Add key parameter to shortcode instead of using title
= 2.0.0 =
* Add facility to store image links and recall using title in shortcode
= 1.1.0 =
